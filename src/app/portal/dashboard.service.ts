...
export class DashboardService {
  ...
  async getTopTenReqGen() {
    const resp = await this.authHttp.get(`${this.apiUrl}/dashboard/getTopTenReqGen`).toPromise()
    return resp.json();
  }
  async getTopTenReqEq() {
    const resp = await this.authHttp.get(`${this.apiUrl}/dashboard/getTopTenReqEq`).toPromise()
    return resp.json();
  }
  async getTopFiveMonthReqEq() {
    const resp = await this.authHttp.get(`${this.apiUrl}/dashboard/getTopFiveMonthReqEq`).toPromise()
    return resp.json();
  }
  async getTopFiveMonthReqGen() {
    const resp = await this.authHttp.get(`${this.apiUrl}/dashboard/getTopFiveMonthReqGen`).toPromise()
    return resp.json();
  }
